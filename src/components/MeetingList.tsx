        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 max-w-sm mx-4 space-y-4">
            ...
            <div className="flex gap-3">
              <button onClick={() => setDeleteConfirm(null)} className="flex-1 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg transition-colors">Cancel</button>
      ...
      <div className="bg-slate-900 border-b border-slate-800 p-6">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-600"
          />
        </div>
      </div>
          ...
          <div className="grid gap-3">
            {filteredMeetings.map((meeting) => (
              <div
                ...
                className="bg-slate-800 border border-slate-700 hover:border-primary-600/50 rounded-xl p-4 cursor-pointer transition-all group"
              >
